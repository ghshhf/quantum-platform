...
Run: `cd /Users/yoko/chaitin/ai/量子平台/backend && go build ./errcode/...`
Expected: 编译成功，无错误
...
import (
	...
	"github.com/ghshhf/quantum-platform/backend/db/hook"
...
Run: `cd /Users/yoko/chaitin/ai/量子平台/backend && go build ./pkg/entx/...`
Expected: 编译成功，无错误
...
Run: `cd /Users/yoko/chaitin/ai/量子平台/backend && go build ./pkg/store/...`
Expected: 编译成功，无错误
...
Run: `cd /Users/yoko/chaitin/ai/量子平台/backend && go build ./ent/...`
Expected: 编译成功，无错误
