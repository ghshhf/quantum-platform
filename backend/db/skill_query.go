...
type SkillQuery struct {
	...
	withTeamGroupSkills *TeamGroupSkillQuery
...
func (_q *SkillQuery) QueryUser() *UserQuery {
...
func (_q *SkillQuery) QueryTeams() *TeamQuery {
...
func (_q *SkillQuery) QueryGroups() *TeamGroupQuery {
...
func (_q *SkillQuery) QueryTeamSkills() *TeamSkillQuery {
...
// QueryTeamGroupSkills chains the current query on the "team_group_skills" edge.
func (_q *SkillQuery) QueryTeamGroupSkills() *TeamGroupSkillQuery {
	query := (&TeamGroupSkillClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *SkillQuery) Clone() *SkillQuery {
	...
	return &SkillQuery{
		...
		withTeamGroupSkills: _q.withTeamGroupSkills.Clone(),
...
func (_q *SkillQuery) WithUser(opts ...func(*UserQuery)) *SkillQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *SkillQuery) WithTeams(opts ...func(*TeamQuery)) *SkillQuery {
	query := (&TeamClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SkillQuery) WithGroups(opts ...func(*TeamGroupQuery)) *SkillQuery {
	query := (&TeamGroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SkillQuery) WithTeamSkills(opts ...func(*TeamSkillQuery)) *SkillQuery {
	query := (&TeamSkillClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithTeamGroupSkills tells the query-builder to eager-load the nodes that are connected to
// the "team_group_skills" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *SkillQuery) WithTeamGroupSkills(opts ...func(*TeamGroupSkillQuery)) *SkillQuery {
	query := (&TeamGroupSkillClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withTeamGroupSkills = query
	return _q
}
...
func (_q *SkillQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Skill, error) {
	...
	if query := _q.withTeams; query != nil {
		if err := _q.loadTeams(ctx, query, nodes,
			func(n *Skill) { n.Edges.Teams = []*Team{} },
			func(n *Skill, e *Team) { n.Edges.Teams = append(n.Edges.Teams, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withGroups; query != nil {
		if err := _q.loadGroups(ctx, query, nodes,
			...
			func(n *Skill, e *TeamGroup) { n.Edges.Groups = append(n.Edges.Groups, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTeamSkills; query != nil {
		if err := _q.loadTeamSkills(ctx, query, nodes,
			func(n *Skill) { n.Edges.TeamSkills = []*TeamSkill{} },
			func(n *Skill, e *TeamSkill) { n.Edges.TeamSkills = append(n.Edges.TeamSkills, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTeamGroupSkills; query != nil {
		if err := _q.loadTeamGroupSkills(ctx, query, nodes,
			func(n *Skill) { n.Edges.TeamGroupSkills = []*TeamGroupSkill{} },
			func(n *Skill, e *TeamGroupSkill) { n.Edges.TeamGroupSkills = append(n.Edges.TeamGroupSkills, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SkillQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *User)) error {
...
func (_q *SkillQuery) loadTeams(ctx context.Context, query *TeamQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *Team)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(skill.TeamsTable)
		s.Join(joinT).On(s.C(team.FieldID), joinT.C(skill.TeamsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(skill.TeamsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(skill.TeamsPrimaryKey[1]))
...
func (_q *SkillQuery) loadGroups(ctx context.Context, query *TeamGroupQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *TeamGroup)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uuid.UUID]*Skill)
	nids := make(map[uuid.UUID]map[*Skill]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(skill.GroupsTable)
		s.Join(joinT).On(s.C(teamgroup.FieldID), joinT.C(skill.GroupsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(skill.GroupsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(skill.GroupsPrimaryKey[1]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *SkillQuery) loadTeamSkills(ctx context.Context, query *TeamSkillQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *TeamSkill)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(teamskill.FieldSkillID)
	}
	query.Where(predicate.TeamSkill(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(skill.TeamSkillsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SkillQuery) loadTeamGroupSkills(ctx context.Context, query *TeamGroupSkillQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *TeamGroupSkill)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Skill)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(teamgroupskill.FieldSkillID)
	}
	query.Where(predicate.TeamGroupSkill(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(skill.TeamGroupSkillsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SkillQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(skill.FieldUserID)
		}
	}
